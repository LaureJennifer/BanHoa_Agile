...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=trang;Initial Catalog=QLBH_agile;Integrated Security=True;TrustServerCertificate=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Khachhang>(entity =>
            {
                entity.HasKey(e => e.Idkh)
                    .HasName("PK__KHACHHAN__B87DC1A702576871");
            });

            modelBuilder.Entity<Phieumua>(entity =>
            {
                entity.HasKey(e => e.Idphieumua)
                    .HasName("PK__PHIEUMUA__F3A449366398CAD6");
            ...
            modelBuilder.Entity<Sanpham>(entity =>
            {
                entity.HasKey(e => e.IdsanPham)
                    .HasName("PK__SANPHAM__9D45E58ACC7158D4");
            });
